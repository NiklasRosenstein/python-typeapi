...
from typeapi.utils import (
    get_annotations,
    get_special_forms,
    get_special_generic_aliases,
    is_annotated_alias,
    is_generic_alias,
    is_new_type,
    is_special_form,
    is_special_generic_alias,
    is_typed_dict,
    scoped,
)
...
def test_get_special_generic_aliases():
    assert set(get_special_generic_aliases().keys()).issuperset(
        ["List", "Mapping", "MutableMapping", "Dict", "Callable", "Tuple"]
    )
